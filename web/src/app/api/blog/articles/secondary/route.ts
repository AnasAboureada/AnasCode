  ...
  const secondaryArticles: BlogPost[] = [
    {
      ...
      category: 'Database',
      url: 'https://medium.com/@anas-aboureada/demystifying-database-impedance-mismatch-a-simple-straightforward-guide-bc2bf9bb7493',
    },
    {
      ...
      url: 'https://medium.com/@anas-aboureada/cache-eviction-policies-like-fridge-police-for-your-snacks-cae89070c62d',
    },
  ];
